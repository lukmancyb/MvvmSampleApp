  ...
  public UserDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `User`(`uid`,`id`,`name`,`email`,`password`,`email_verified_at`,`created_at`,`updated_at`) VALUES (?,?,?,?,?,?,?,?)";
      }
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            _result = new User(_tmpId,_tmpName,_tmpEmail,_tmpPassword,_tmpEmail_verified_at,_tmpCreated_at,_tmpUpdated_at);
            final int _tmpUid;
